...
<head>
	...
	<title>Aadhaar Reprint Homepage</title>
...
<body>
	...
	<div class="col-12 padding-sidenav pr-md-0 main-ind">
		<div class="mt-4 mb-0 d-md-none">
			<h2 class="formheader">Aadhaar Reprint</h2>
		</div>
		<form class="form-container mt-4 form-padding-internal" action="./Admin2_backend/aadhar_reprint_all.php" method="post" enctype="multipart/form-data">
