...
$sql = "INSERT INTO admin2_replies(type,comments,reply,q_id,date) VALUES('$type','$comments','$reply','$q_id','$db_date')";
// print($sql);
if (mysqli_query($conn, $sql)) {
    $sql = "UPDATE aadharpan_link SET status='true' WHERE id ='$q_id'";
