...
$sql = "INSERT INTO admin2_replies(type,reply,comments,q_id,r_id,date) VALUES('$type', '$reply','$comments','$q_id','$r_id','$db_date')";
// print($sql);
if (mysqli_query($conn, $sql)) {
    $sql = "UPDATE pvc_card SET status='true' WHERE id ='$q_id'";
