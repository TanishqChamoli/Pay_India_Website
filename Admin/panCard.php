...
<body>
	...
	<div class="col-12 padding-sidenav pr-md-0 main-index">
		<div class="mt-4 mb-0 d-md-none">
			<h2 class="formheader">Pan Card</h2>
		</div>
		<form class="form-container mt-4 form-padding-internal" action="./Admin2_backend/panCard_all.php" method="post" enctype="multipart/form-data">
