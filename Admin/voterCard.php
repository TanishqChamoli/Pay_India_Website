...
<body>
	...
	<div class="col-12 padding-sidenav pr-md-0 main-index">
		...
		<form class="form-container mt-4 form-padding-internal" action="./Admin2_backend/votercard_all.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input class="form-control" type="file" id="myFile" name="reply" required>
			</div>
			<div class="form-group">
