...
if (isset($_GET['id'])) {
	...
	$result = mysqli_query($conn, $sql);
	if ($result == 1) {
		$address = "http://localhost/Pay%20India%20Website/Admin/aadharUTIPending.php";
					...
					?>
						<tbody>
							<tr>
								...
								<td>
									<a href="http://localhost/Pay%20India%20Website/Admin/aadharUTIPending.php?id=<?php echo $ans[$x]['id']; ?>"><input type="button" value="Reject"></a>
								</td>
								<td>
									<a href="http://localhost/Pay%20India%20Website/Admin/AadhaarUTI.php?id=<?php echo $ans[$x]['id']; ?>"><input type="button" value="Reply"></a>
								</td>
							</tr>
					<?php
					}
