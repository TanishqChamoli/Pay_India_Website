...
<head>
	...
	<title>Bill Payment Pending Homepage</title>
					...
					?>
						<tbody>
							<tr>
								...
								<td>
									<a href="http://localhost/Pay%20India%20Website/Admin/billPayment.php?id=<?php echo $ans[$x]['id']; ?>"><input type="button" value="Reply"></a>
								</td>
							</tr>
					<?php
					}
