	...
	<nav class="navbar navbar-expand-md navbar-dark bg-brand d-md-none d-flex">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<li>
					<a href="aaharreprint.php" class="nav-link active">Aadhar Reprint</a>
				</li>
				<li>
		...
		<div class="row">
			...
			<div class="col-md-3 d-none d-md-flex sidenav-index">
				<div class="sidenav">
					...
					<a href="aadharreprint.php" class="sidenav-link active">Aadhar Reprint</a>
			...
			<div class="col-12 padding-sidenav px-0 pr-md-0">
				<div class="topnav">
					<h2 class="formheader">Aadhar Reprint</h2>
			...
			<div class="col-12 padding-sidenav pr-md-0 main-index">
				...
				<form class="form-container mt-4 form-padding-internal" action="backend/aadhar_b.php" method="POST" enctype="multipart/form-data">
