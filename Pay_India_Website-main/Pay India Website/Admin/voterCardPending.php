...
<head>
	...
	<title>Voter Card Pending Homepage</title>
					...
					?>
						<tbody>
							<tr>
								...
								<td>
									<a href="http://localhost/Pay%20India%20Website/Admin/voterCard.php?id=<?php echo $ans[$x]['id']; ?>"><input type="button" value="Reply"></a>
								</td>
							</tr>
					<?php
					}
