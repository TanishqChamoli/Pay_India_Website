...
<body>
    ...
    <div class="container">
    	<div class="row">
    		<div class="col-md-12">
    			<h1 class="text-center mt-3 mb-3">MSME</h1>
    		</div>
    	</div>
    	<div class="row">
    		...
    		<div class="col-12">
    			...
    			<div class="mt-4 mb-0 d-md-none">
		   		...
		   		<form class="form-container mt-4 mb-4" action="backend/msme_b.php" method = "post" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <div class="form-check-inline">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="ew" checked>Yes
							  </label>
							</div>
							<div class="form-check-inline">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="ew">No
							  </label>
							</div>
						</div>
					  ...
					  <div class="form-group">
					   <label class="required">Physically Handicapped</label><br>
					     <div class="form-check-inline">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="optradio1">Yes
							  </label>
							</div>
							<div class="form-check-inline">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="optradio1" checked>No
							  </label>
							</div>
					  </div>
