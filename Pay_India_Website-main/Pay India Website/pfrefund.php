...
<body>
    ...
    <div class="container mb-5">
    	<div class="row">
    		<div class="col-md-12">
    			<h1 class="text-center mt-3 mb-3">PF Refund</h1>
    		</div>
    	</div>
    	<div class="row">
    		...
    		<div class="col-12">
    			...
    			<div class="mt-4 mb-0 d-md-none">
		   		...
		   		<form class="form-container mt-4"  action="backend/pfrefund_b.php" method = "post" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <select name="request" id="request" class="form-control">
						  ...
						  <option value="Full PF + Pension Withdrawl">Full PF + Pension Withdrawl</option>
						  <option value="75% Advance Required">75% Advance Required</option>
						  <option value="Transfer PF amount to current company">Transfer PF amount to current company</option>
						  <option value="Update KYC">Update KYC</option>
						   <option value="Relieving date update">Relieving date update</option>
						</select>
					  </div>
