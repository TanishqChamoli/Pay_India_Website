...
<body>
    ...
    <div class="container mb-5">
    	<div class="row">
    		<div class="col-md-12">
    			<h1 class="text-center mt-3 mb-3">Voter Card</h1>
    		</div>
    	</div>
    	<div class="row">
    		...
    		<div class="col-12">
				...
				<form class="form-container mt-4" action="backend/votercard_b.php" method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					  		<label class="required" for="ageproofdocument">Upload Age Proof</label>
					  		 <input class="form-control" type="file" id="ageproofdocument" name="ageproofdocument">
					  </div>

					  <div class="form-group">
					  		<label class="required" for="addressproofdocument">Upload Address Proof</label>
					  		 <input class="form-control" type="file" id="addressproofdocument" name="addressproofdocument">
					  </div>
